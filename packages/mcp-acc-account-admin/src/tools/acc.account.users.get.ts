...
export function registerAccAccountUsersGet(server: McpServer) {
  server.registerTool(
    "acc_account_users_get",
    {
      title: "ACC Account.Users.Get",
      description:
        "Lista usuarios del account (HQ endpoint) usando accountId derivado de hubId/env.",
