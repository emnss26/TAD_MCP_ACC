...
export function registerBim360CompaniesGet(server: McpServer) {
  server.registerTool(
    "bim360_companies_get",
    {
      title: "BIM 360 Companies.Get",
      description:
        "Lista companias del account usando HQ v1 (BIM 360).",
    ...
    async (args: InputArgs) => {
      ...
      const payload = finalizePayload(
        ...
        buildMcpResponse({
          ...
          meta: {
            tool: "bim360_companies_get",
            generatedAt: new Date().toISOString(),
            source: "hq/v1/accounts/:account_id/companies",
