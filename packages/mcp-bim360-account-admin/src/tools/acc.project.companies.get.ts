...
export function registerBim360ProjectCompaniesGet(server: McpServer) {
  server.registerTool(
    "bim360_project_companies_get",
    {
      title: "BIM 360 Project.Companies.Get",
      description:
    ...
    async (args: InputArgs) => {
      ...
      if (data.schemaWarning) {
        warnings.push({
          ...
          source: "bim360_project_companies_get"
        });
      }
      ...
      const payload = finalizePayload(
        ...
        buildMcpResponse({
          ...
          meta: {
            tool: "bim360_project_companies_get",
