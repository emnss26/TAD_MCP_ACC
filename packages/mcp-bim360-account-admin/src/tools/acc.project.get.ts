...
export function registerBim360ProjectsGet(server: McpServer) {
  server.registerTool(
    "bim360_projects_get",
    {
      title: "BIM 360 Projects.Get",
      description:
        "Lista proyectos del account usando Construction Admin (BIM 360).",
