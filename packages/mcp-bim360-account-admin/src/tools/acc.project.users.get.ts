...
export function registerBim360ProjectUsersGet(server: McpServer) {
  server.registerTool(
    "bim360_project_users_get",
    {
      title: "BIM 360 Project.Users.Get",
      description:
    ...
    async (args: InputArgs) => {
      ...
      if (data.schemaWarning) {
        warnings.push({
          ...
          source: "bim360_project_users_get"
        });
      }
